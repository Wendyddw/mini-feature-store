...
/** In-memory implementation of Writers for testing.
  *
  * Stores DataFrames as materialized Row data with their schemas, making them independent of the
  * SparkSession lifecycle. This ensures test data remains valid even if the SparkSession is
  * recreated.
  *
  * @param spark
...
class TestWriter(spark: SparkSession) extends Writers {
  ...
  /** Stores DataFrame data by materializing it immediately. This ensures data is independent of the
    * original DataFrame's SparkSession.
    */
